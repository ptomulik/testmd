...
of an already-tested class such as standard `Hash`. Reusable *shared\_examples*
...
designed such that they compare behaviour of a subject class with a behaviour
of an already-tested class such as standard `Hash`. Reusable *shared\_examples*
are provided for developers who want to implement cusom `Vash` classes (these
examples may be actually used to test any class that is intended to behave as
Hash, Vash::Validator or complete Vash). 
